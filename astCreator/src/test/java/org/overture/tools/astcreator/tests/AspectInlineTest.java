...
public class AspectInlineTest extends TestCase {
	...
	public void test() throws IOException, InstantiationException,
		...
		File output = new File(
				FilePathUtil.getPlatformPath("target/testData/aspectInline"));
		String inputFile = TESTDATA_BASE + "aspectInline.astv2";
		Main.create(
				null,
