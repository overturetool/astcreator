...
public class SetMethod extends Method
{
	...
	protected void prepare()
	{
		...
		if ((!f.isTokenField && !(env.getClassType(c) == ClassType.Custom))
				|| (f.type instanceof ExternalJavaClassDefinition && ((ExternalJavaClassDefinition) f.type).extendsNode))
		{
			if (f.isList)
			{
